...
public class PhongBan {
	...
	public void setMaPhongBan(String maPhongBan)throws Exception {
		...
		}else if (!maPhongBan.matches("^PB[1-9][0-9]{4}$")) {
            throw new Exception("Mã phòng ban phải theo định dạng PBxxxxx với x là các kí tự số, x đầu tiên từ [1-9], x sau từ [0-9]!");
        } else {
	...
	public void setTenPhongBan(String tenPhongBan) throws Exception{
		if (tenPhongBan.equals("")) {
            ...
            throw new Exception ("Tên phòng ban chỉ chứa chữ");
        } else{
