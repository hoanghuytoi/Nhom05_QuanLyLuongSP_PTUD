...
public class ThongTinHD {
	...
	public String toString() {
		return "ReportBean [time=" + time + ", maHopDong=" + maHopDong + ", tenHopDong=" + tenHopDong
	...
	public ThongTinHD(String time, String maHopDong, String tenHopDong, String tenKhachHang, String nguoiKyKet,
